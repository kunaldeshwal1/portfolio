...
export function Navbar() {
  ...
  const navItems = ["Overview", "Skills", "Projects"];
            ...
            {navItems.map((item) => (
              <li key={item}>
                ...
                >
                  {item}
                  {activeSection === item.toLowerCase() && (
                    <span className="absolute -bottom-3 left-0 w-full h-1 bg-blue-500 rounded-full" />
                  )}
                </a>
              </li>
            ))}
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-800 transition-colors"
              >
                <svg
